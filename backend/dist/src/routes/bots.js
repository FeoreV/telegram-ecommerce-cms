...
router.post('/', requireRole(['OWNER', 'ADMIN']), botController_js_1.createBot);
router.delete('/:storeId', requireRole(['OWNER', 'ADMIN']), botController_js_1.removeBot);
router.put('/:storeId/settings', requireRole(['OWNER', 'ADMIN']), botController_js_1.updateBotSettings);
...
router.post('/:storeId/restart', requireRole(['OWNER', 'ADMIN']), botController_js_1.restartBot);
router.get('/global/stats', requireRole(['OWNER']), botController_js_1.getGlobalBotStats);
router.post('/:storeId/webhook/enable', requireRole(['OWNER', 'ADMIN']), botController_js_1.enableWebhook);
router.post('/:storeId/webhook/disable', requireRole(['OWNER', 'ADMIN']), botController_js_1.disableWebhook);
