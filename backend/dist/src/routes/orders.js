...
router.post('/', csrfProtection_1.csrfProtection, [
...
router.post('/:id/payment-proof', csrfProtection_1.csrfProtection, uploadRateLimit_1.uploadRateLimitMiddleware, [(0, express_validator_1.param)('id').isString().withMessage('Valid order ID required')], validation_1.validate, (req, res, next) => {
    uploadPaymentProof_1.uploadPaymentProof.single('paymentProof')(req, res, next);
}, orderController_1.uploadOrderPaymentProof);
router.post('/:id/ship', csrfProtection_1.csrfProtection, (0, auth_1.requireRole)([jwt_1.UserRole.OWNER, jwt_1.UserRole.ADMIN]), [
    (0, express_validator_1.param)('id').isString().withMessage('Valid order ID required'),
...
router.post('/:id/deliver', csrfProtection_1.csrfProtection, (0, auth_1.requireRole)([jwt_1.UserRole.OWNER, jwt_1.UserRole.ADMIN]), [
    (0, express_validator_1.param)('id').isString().withMessage('Valid order ID required'),
...
router.post('/:id/cancel', csrfProtection_1.csrfProtection, (0, auth_1.requireRole)([jwt_1.UserRole.OWNER, jwt_1.UserRole.ADMIN]), [
    (0, express_validator_1.param)('id').isString().withMessage('Valid order ID required'),
