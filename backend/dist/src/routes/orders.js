...
router.get('/export', orderController_1.exportOrders);
...
router.post('/', (0, csrfProtection_1.csrfProtection)(), [
...
router.post('/:id/confirm-payment', (0, csrfProtection_1.csrfProtection)(), (0, auth_1.requireRole)([jwt_1.UserRole.OWNER, jwt_1.UserRole.ADMIN]), [(0, express_validator_1.param)('id').isString().withMessage('Valid order ID required')], validation_1.validate, (0, auditLog_1.auditOrderAction)(auditLog_1.AuditAction.ORDER_CONFIRMED), orderController_1.confirmPayment);
router.post('/:id/reject', (0, csrfProtection_1.csrfProtection)(), (0, auth_1.requireRole)([jwt_1.UserRole.OWNER, jwt_1.UserRole.ADMIN]), [
...
router.post('/:id/payment-proof', (0, csrfProtection_1.csrfProtection)(), uploadRateLimit_1.uploadRateLimitMiddleware, [(0, express_validator_1.param)('id').isString().withMessage('Valid order ID required')], validation_1.validate, (req, res, next) => {
    uploadPaymentProof_1.uploadPaymentProof.single('paymentProof')(req, res, next);
}, orderController_1.uploadOrderPaymentProof);
router.post('/:id/ship', (0, csrfProtection_1.csrfProtection)(), (0, auth_1.requireRole)([jwt_1.UserRole.OWNER, jwt_1.UserRole.ADMIN]), [
    (0, express_validator_1.param)('id').isString().withMessage('Valid order ID required'),
...
router.post('/:id/deliver', (0, csrfProtection_1.csrfProtection)(), (0, auth_1.requireRole)([jwt_1.UserRole.OWNER, jwt_1.UserRole.ADMIN]), [
    (0, express_validator_1.param)('id').isString().withMessage('Valid order ID required'),
...
router.post('/:id/cancel', (0, csrfProtection_1.csrfProtection)(), (0, auth_1.requireRole)([jwt_1.UserRole.OWNER, jwt_1.UserRole.ADMIN]), [
    (0, express_validator_1.param)('id').isString().withMessage('Valid order ID required'),
