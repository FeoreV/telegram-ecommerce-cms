...
router.post('/', (0, csrfProtection_1.csrfProtection)(), (0, auth_1.requireRole)([jwt_1.UserRole.OWNER]), [
...
router.post('/restore/:filename', (0, csrfProtection_1.csrfProtection)(), (0, auth_1.requireRole)([jwt_1.UserRole.OWNER]), [
    (0, express_validator_1.param)('filename').isString().notEmpty().withMessage('Filename is required'),
...
router.delete('/:filename', (0, csrfProtection_1.csrfProtection)(), (0, auth_1.requireRole)([jwt_1.UserRole.OWNER]), [
    (0, express_validator_1.param)('filename').isString().notEmpty().withMessage('Filename is required'),
], validation_1.validate, backupController_1.deleteBackup);
router.put('/schedule', (0, csrfProtection_1.csrfProtection)(), (0, auth_1.requireRole)([jwt_1.UserRole.OWNER]), [
