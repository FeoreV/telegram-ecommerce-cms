...
router.post('/accept', (0, csrfProtection_1.csrfProtection)(), invitationController_1.acceptInvitation);
router.post('/reject', (0, csrfProtection_1.csrfProtection)(), invitationController_1.rejectInvitation);
