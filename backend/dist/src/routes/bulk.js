...
router.post('/import/products', (0, permissions_1.requirePermission)(permissions_1.Permission.PRODUCT_CREATE), bulkController_1.upload.single('csv'), [
...
router.patch('/update/products', (0, permissions_1.requirePermission)(permissions_1.Permission.PRODUCT_UPDATE), [
    (0, express_validator_1.body)('storeId').isString().withMessage('Store ID is required'),
...
router.delete('/delete/products', (0, permissions_1.requirePermission)(permissions_1.Permission.PRODUCT_DELETE), [
    (0, express_validator_1.body)('storeId').isString().withMessage('Store ID is required'),
    (0, express_validator_1.body)('productIds').isArray({ min: 1 }).withMessage('Product IDs array is required'),
    (0, express_validator_1.body)('productIds.*').isString().withMessage('Each product ID must be a string'),
