...
router.post('/stock/update', (0, permissions_1.requirePermission)(permissions_1.Permission.PRODUCT_UPDATE), [
...
router.post('/alerts/config', (0, permissions_1.requirePermission)(permissions_1.Permission.STORE_UPDATE), [
