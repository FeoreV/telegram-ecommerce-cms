...
const ThemeSwitcher = ({ onThemeChange }) => {
    ...
    const [seedColor, setSeedColor] = (0, react_1.useState)(localStorage.getItem('admin-seed-color') || '#0088cc');
    (0, react_1.useEffect)(() => {
        ...
        applyTheme(defaultTheme, seedColor);
    }, []);
    const applyTheme = (theme, seed) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { style: {
            ...
            boxShadow: '0 2px 8px rgba(0, 0, 0, 0.1)'
        }, children: [(0, jsx_runtime_1.jsxs)("button", { onClick: toggleTheme, style: {
                    background: 'none',
                    border: 'none',
                    cursor: 'pointer',
                    fontSize: '16px',
                ...
                }, title: isDarkMode ? 'Переключить на светлую тему' : 'Переключить на темную тему', children: [(0, jsx_runtime_1.jsx)("span", { style: { fontSize: '18px' }, children: isDarkMode ? '☀️' : '🌙' }), (0, jsx_runtime_1.jsx)("span", { style: { fontSize: '14px', fontWeight: '500' }, children: isDarkMode ? 'Светлая' : 'Темная' })] }), (0, jsx_runtime_1.jsxs)("div", { style: { display: 'flex', alignItems: 'center', gap: '8px', marginTop: '8px' }, children: [(0, jsx_runtime_1.jsx)("input", { type: "color", value: seedColor, onChange: onSeedChange, title: "\u0411\u0430\u0437\u043E\u0432\u044B\u0439 \u0446\u0432\u0435\u0442 (Material You)", style: { width: '36px', height: '28px', border: 'none', background: 'transparent', cursor: 'pointer' } }), (0, jsx_runtime_1.jsx)("span", { style: { fontSize: '12px', color: 'var(--color-text, #333333)' }, children: "\u041C\u0430\u0442\u0435\u0440\u0438\u0430\u043B: \u0431\u0430\u0437\u043E\u0432\u044B\u0439 \u0446\u0432\u0435\u0442" })] })] }));
};
