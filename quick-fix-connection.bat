...
curl -s http://82.147.84.78:3001/health >nul 2>&1
if %errorlevel% equ 0 (
...
curl -s http://82.147.84.78:3001/api >nul 2>&1
if %errorlevel% equ 0 (
...
echo.
echo Backend URL: http://82.147.84.78:3001
echo Frontend должен использовать:
echo   - Локально: http://82.147.84.78:3001/api
...
echo 2. Откройте браузер: http://82.147.84.78:3000 (dev) или https://megapenis.work.gd (prod)
